...
export function SceneReviewPanel({
  ...
  return (
    ...
    >
      ...
      {segments.length > 0 ? (
        <ol
          className="flex max-h-[32rem] min-h-0 flex-col gap-2 overflow-y-auto p-3 lg:max-h-[min(40rem,70vh)]"
              ...
              >
                <div className="flex flex-wrap items-center gap-2">
                  <button
                    ...
                    className="min-h-11 flex-1 text-left font-body text-[0.6875rem] font-bold uppercase tracking-[0.12em] tabular-nums text-muted hover:text-paper"
                  >
                    {index + 1}. {formatTimecode(segment.startMs)} – {formatTimecode(segment.endMs)}
                  </button>
                  <button
                    type="button"
                ...
                <button
                  ...
                  className={`min-h-11 w-full border-2 px-3 font-display text-[0.625rem] uppercase tracking-widest disabled:opacity-40 ${
                    usaOriginal
